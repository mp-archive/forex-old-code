...
//          lastopen2_i_m   NINCS
//       section and stopafterhour
//       build felesleges prarméterezés ,   slp,tpp újraírása     trailing bid -> ask    +spread
//       
//       
//       READY TO TEST last_posiions_profit ... ne csak az utolsó lezártat hanem az idõben egyszerre lezártakat tekintse egynek
//       only order direction
//       stop_after_nr baromság !!!!!
//       
//       READY TO TEST sl_onavgprice ki lehetne venni eleve benne van a section 2black-nél v módosítani hogy tényleg csak az átlagot nézze.
//       
//       stopafterhour and tpprice slprice (section)
...
//       hedging
//       reportba: max lenght, avg pip, max pip
//
//       
//    JAVÍTANI:
...
void F_close(int order_type)
   {  bool b_lezar=false; int b_lezar_kod=0;         
      ...
      if (stop_st3_out!=0 && st3_dir*open_type<=-stop_st3_out) { b_lezar=true; b_lezar_kod=14;}  
