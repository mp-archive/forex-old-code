...
#define MAGIC_d2l 10010099
   ...
   /* Daily 2 limit single settings */    extern double Movement =400,  TakeProfit = 200,   StopLoss =500;
   ...
   string   symbols[10]=         {"EURGBP"   ,"EURUSD"   ,"EURCHF"   ,"EURJPY"   ,"GBPUSD"   ,"GBPCHF"   ,"GBPJPY"   ,"USDCHF"   ,"USDJPY"   ,"CHFJPY"};
   ...
   double   move_symbol[10] =    {400        ,55         ,45         ,45         ,400        ,45         ,45         ,450        ,20         ,50      };
   double   takep_symbol[10] =   {200        ,20         ,45         ,45         ,200        ,45         ,45         ,200        ,15         ,15      };
   double   stopl_symbol[10] =   {500        ,55         ,45         ,45         ,500        ,45         ,45         ,500        ,50         ,70      };
   double   bid[10] ;
   double   ask[10] ;
   double   point[10];
   int      digits[10];
