...
{  double res=0.0,res1=0.0,res2=0.0,res3=0.0,res4=0.0,res5=0.0,res6=0.0,res7=0.0,tester_tmp=0.0;
   ...
   if (TesterStatistics(STAT_EQUITY_DDREL_PERCENT)!=0) res7=MathRound((TesterStatistics(STAT_PROFIT)/TesterStatistics(STAT_INITIAL_DEPOSIT)+1)/TesterStatistics(STAT_EQUITY_DDREL_PERCENT)/5)*100;
   Print("ULTREC    ",res1);
