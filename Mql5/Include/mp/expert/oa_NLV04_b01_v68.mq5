   ...
   input double in_tp2=3.0;
   input double in_sl2=3.0;
...
{  double res=0.0,res1=0.0,res2=0.0,res3=0.0,res4=0.0,res5=0.0,res6=0.0,res7=0.0,tester_tmp=0.0;
   ...
   res1=MathRound(TesterStatistics(STAT_PROFIT)/TesterStatistics(STAT_EQUITY_DD)/(tester_ts/(60*60*24*250))*1000)/1000;         
   ...
   {  bool b_lezar=false; int b_lezar_kod=0;         
      ...
      if (b_lezar==false) return;
         ...
         if (b_lezar==true && TimeCurrent()-GGetLastSendOrder() >5)    
         {
           ...
           Print("  ELADÁS !!!" , lots2, "      ",lastprofit, "      ",  open_nr, "   kód: ",b_lezar_kod, "  sl/tp:  ",sl_price,"  ",tp_price,"  ","  Ask:",Ask,"   Bid:",Bid,"  ",MAGIC_Rf);  open_nr=0; 
